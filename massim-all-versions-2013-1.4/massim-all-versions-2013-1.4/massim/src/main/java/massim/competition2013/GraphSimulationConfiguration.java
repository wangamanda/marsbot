...
import massim.competition2013.scenario.ActionConfiguration;
...
//	/**
//	 * Factor for weighting the random and the gradient component of the nodeWeight. 
//	 * 100 means totally random, 0 means a fully gradient weight.
//	 */
//	public int nodeWeighting;
	...
	/**
	 * The probability of deleting an edge to thin out the graph
	 */
...
//			agentsPerTeam  =   Integer.decode(source.getAttribute("agentsPerTeam"));
			...
			randomWeight =     Integer.decode(source.getAttribute("randomWeight"));
			gradientWeight =   Integer.decode(source.getAttribute("gradientWeight"));
			optimaWeight =     Integer.decode(source.getAttribute("optimaWeight"));
			blurIterations =   Integer.decode(source.getAttribute("blurIterations"));
			optimaPercentage = Integer.decode(source.getAttribute("optimaPercentage"));
			thinning =     	   Integer.decode(source.getAttribute("thinning"));
		...
		mapGenerator = source.getAttribute("mapGenerator");
